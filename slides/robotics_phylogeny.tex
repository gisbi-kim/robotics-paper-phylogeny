...
\textbf{Top-5 Classes} \muted{\scriptsize (166 papers)}\\[2pt]
\scriptsize
\begin{tabular}{@{}rlr@{}}
    1. & Manipulation > General Manipulati… & 20 \\
    2. & Theoretical Foundations > Kinemat… & 20 \\
...
\scriptsize Manipulation (40), Theoretical Foundations (37), Planning (19)
\end{column}
...
\begin{columns}[T,onlytextwidth]
\begin{column}{0.52\textwidth}
\textbf{Top-5 Classes} \muted{\scriptsize (210 papers)}\\[2pt]
\scriptsize
\begin{tabular}{@{}rlr@{}}
    1. & Manipulation > General Manipulati… & 26 \\
    2. & Planning > Path/Motion Planning & 20 \\
    3. & Theoretical Foundations > Kinemat… & 15 \\
...
\textbf{\small Top-3 Phyla}\\[2pt]
\scriptsize Manipulation (61), Theoretical Foundations (32), Planning (25)
\end{column}
...
\begin{tabular}{@{}p{0.95\linewidth}@{}}
    \hot{$+$19} \#7: Robot Design \& Hardware > Mec… (9) \\
    \hot{$+$7} \#9: Locomotion > Wheeled Locomoti… (9) \\
    \hot{$+$5} \#6: Control > Force / Impedance C… (10) \\
    \hot{$+$4} \#11: Control > General Control (7) \\
    \hot{$+$2} \#15: Perception \& Sensing > Visual… (5) \\
\end{tabular}
\end{column}
\end{columns}
\end{frame}
...
\begin{columns}[T,onlytextwidth]
\begin{column}{0.52\textwidth}
\textbf{Top-5 Classes} \muted{\scriptsize (365 papers)}\\[2pt]
\scriptsize
\begin{tabular}{@{}rlr@{}}
    1. & Robot Design \& Hardware > Mechani… & 26 \\
    2. & Planning > Path/Motion Planning & 25 \\
    3. & Other / Editorial > Editorial / M… & 23 \\
    4. & Locomotion > Legged Locomotion & 19 \\
    5. & Manipulation > General Manipulati… & 17 \\
\end{tabular}
\vspace{8pt}

\textbf{\small Top-3 Phyla}\\[2pt]
\scriptsize Manipulation (60), Planning (43), Locomotion (39)
\end{column}
...
\scriptsize
\begin{tabular}{@{}p{0.95\linewidth}@{}}
    \hot{$+$83} \#13: Human-Robot Interaction > Tel… (9) \\
    \hot{$+$77} \#19: Perception \& Sensing > Acoust… (7) \\
    \hot{$+$39} \#3: Other / Editorial > Editorial… (23) \\
    \hot{$+$22} \#23: Robot Software \& Architecture… (5) \\
    \hot{$+$18} \#21: Control > Visual Servoing (5) \\
\end{tabular}
\end{column}
\end{columns}
\end{frame}
...
\small
\begin{block}{Headline}
FastSLAM/EKF-SLAM/GraphSLAM 패러다임이 SLAM을 \#9 $\to$ 주류로 끌어올림 (+43 ranks). Aerial, Medical surgical, Assistive robotics 동시 등장.
\end{block}
\vspace{4pt}

\begin{columns}[T,onlytextwidth]
\begin{column}{0.52\textwidth}
\textbf{Top-5 Classes} \muted{\scriptsize (951 papers)}\\[2pt]
\scriptsize
\begin{tabular}{@{}rlr@{}}
    1. & Locomotion > Legged Locomotion & 67 \\
    2. & Robot Design \& Hardware > Mechani… & 63 \\
    3. & Planning > Path/Motion Planning & 57 \\
    4. & Control > General Control & 46 \\
    5. & Manipulation > Contact-rich Manip… & 45 \\
\end{tabular}
\vspace{8pt}

\textbf{\small Top-3 Phyla}\\[2pt]
\scriptsize Locomotion (138), Manipulation (112), Control (88)
\end{column}
...
\scriptsize
\begin{tabular}{@{}p{0.95\linewidth}@{}}
    \hot{$+$73} \#40: Human-Robot Interaction > Ass… (6) \\
    \hot{$+$43} \#9: SLAM \& Localization > SLAM (34) \\
    \hot{$+$35} \#19: SLAM \& Localization > State E… (19) \\
    \hot{$+$30} \#26: Application Domains > Medical… (11) \\
    \hot{$+$28} \#25: Locomotion > Aerial Locomotion (11) \\
\end{tabular}
\end{column}
\end{columns}
\end{frame}
...
\begin{columns}[T,onlytextwidth]
\begin{column}{0.52\textwidth}
\textbf{Top-5 Classes} \muted{\scriptsize (1,308 papers)}\\[2pt]
\scriptsize
\begin{tabular}{@{}rlr@{}}
    1. & Planning > Path/Motion Planning & 95 \\
    2. & Locomotion > Legged Locomotion & 66 \\
    3. & Multi-Robot Systems > Coordination & 63 \\
    4. & Manipulation > Contact-rich Manip… & 60 \\
    5. & SLAM \& Localization > SLAM & 52 \\
\end{tabular}
\vspace{8pt}

\textbf{\small Top-3 Phyla}\\[2pt]
\scriptsize Locomotion (171), Manipulation (141), Planning (141)
\end{column}
...
\scriptsize
\begin{tabular}{@{}p{0.95\linewidth}@{}}
    \hot{$+$80} \#43: Learning for Robotics > Reinf… (8) \\
    \hot{$+$77} \#46: Learning for Robotics > Datas… (7) \\
    \hot{$+$74} \#49: Learning for Robotics > Deep … (7) \\
    \hot{$+$72} \#51: Theoretical Foundations > For… (6) \\
    \hot{$+$27} \#22: Perception \& Sensing > Tactil… (23) \\
\end{tabular}
\end{column}
\end{columns}
\end{frame}
...
\begin{columns}[T,onlytextwidth]
\begin{column}{0.52\textwidth}
\textbf{Top-5 Classes} \muted{\scriptsize (1,349 papers)}\\[2pt]
\scriptsize
\begin{tabular}{@{}rlr@{}}
    ...
    5. & Other / Unclassified > Unclassifi… & 49 \\
\end{tabular}
\vspace{8pt}

\textbf{\small Top-3 Phyla}\\[2pt]
\scriptsize Planning (164), Locomotion (164), Manipulation (143)
\end{column}
...
\scriptsize
\begin{tabular}{@{}p{0.95\linewidth}@{}}
    \hot{$+$71} \#57: Planning > Task \& Motion Plan… (5) \\
    \hot{$+$38} \#15: Human-Robot Interaction > Phy… (32) \\
    \hot{$+$34} \#34: Learning for Robotics > Found… (12) \\
    \hot{$+$33} \#39: Multi-Robot Systems > Multi-R… (9) \\
    \hot{$+$33} \#38: Human-Robot Interaction > Sha… (9) \\
\end{tabular}
\end{column}
\end{columns}
\end{frame}
...
\begin{columns}[T,onlytextwidth]
\begin{column}{0.52\textwidth}
\textbf{Top-5 Classes} \muted{\scriptsize (1,547 papers)}\\[2pt]
\scriptsize
\begin{tabular}{@{}rlr@{}}
    1. & Planning > Path/Motion Planning & 103 \\
    2. & Multi-Robot Systems > Coordination & 70 \\
    3. & Manipulation > Contact-rich Manip… & 66 \\
...
\textbf{\small Top-3 Phyla}\\[2pt]
\scriptsize Manipulation (179), Planning (168), Locomotion (154)
\end{column}
...
\scriptsize
\begin{tabular}{@{}p{0.95\linewidth}@{}}
    \hot{$+$72} \#62: Perception \& Sensing > Radar … (5) \\
    \hot{$+$36} \#17: Perception \& Sensing > Tactil… (29) \\
    \hot{$+$19} \#64: Theoretical Foundations > Rob… (5) \\
    \hot{$+$17} \#53: Theoretical Foundations > Sta… (8) \\
    \hot{$+$17} \#12: Learning for Robotics > Reinf… (38) \\
\end{tabular}
\end{column}
\end{columns}
\end{frame}
...
\small
\begin{block}{Headline}
Foundation Models가 단 3년만에 +52 ranks $\to$ \#3 (66편). Diffusion Policy · VLA · 3D Gaussian Splatting SLAM이 동시기에 등장.
\end{block}
\vspace{4pt}

\begin{columns}[T,onlytextwidth]
\begin{column}{0.52\textwidth}
\textbf{Top-5 Classes} \muted{\scriptsize (1,581 papers)}\\[2pt]
\scriptsize
\begin{tabular}{@{}rlr@{}}
    1. & Planning > Path/Motion Planning & 117 \\
    2. & SLAM \& Localization > SLAM & 72 \\
    3. & Learning for Robotics > Foundatio… & 66 \\
...
\textbf{\small Top-3 Phyla}\\[2pt]
\scriptsize Manipulation (198), Planning (188), Learning for Robotics (159)
\end{column}
...
\scriptsize
\begin{tabular}{@{}p{0.95\linewidth}@{}}
    \hot{$+$52} \#3: Learning for Robotics > Found… (66) \\
    \hot{$+$28} \#43: Control > Safety-Critical Con… (12) \\
    \hot{$+$28} \#22: Control > Optimal / Predictiv… (23) \\
    \hot{$+$24} \#62: Perception \& Sensing > Event-… (6) \\
    \hot{$+$24} \#24: Learning for Robotics > Datas… (21) \\
\end{tabular}
\end{column}
\end{columns}
\end{frame}
